  ...
  <div>
    ...
    <div className="cv container">
      ...
      <div className="cv-body">
        <Fade right cascade>
          <h3 className="cv-body-experiences">Experiences</h3>
        ...
        <Fade left cascade>
          <h3 className="cv-body-education">Formations</h3>
        ...
        <Fade right cascade>
          <h3 className="cv-body-languages">Langues</h3>
        ...
        <Fade left cascade>
          <h3 className="cv-body-hobbies">Loisirs</h3>
